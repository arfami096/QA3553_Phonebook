...
def test_login_with_wrong_email(driver):
    ...
    login_page.fill_password(VALID_PASSWORD)
    login_page.take_screenshot("wrong_mail_test")
    login_page.submit_login()
...
def test_login_with_wrong_password(driver):
    ...
    login_page.take_screenshot("wrong_password_test")
    login_page.submit_login()
...
def test_login_unregistered_user(driver):
    login_page = LoginPage(driver)
    login_page.open_login_form()
    login_page.fill_email("noregistereduser@gmail.com")
    login_page.fill_password(VALID_PASSWORD)
    login_page.take_screenshot("unreg_user_test")
    login_page.submit_login()
